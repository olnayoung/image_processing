...
def test_freeU():
    try:
        ...
        pipeline = StableDiffusionFillInpaintPipeline.from_pretrained("Uminosachi/realisticVisionV40_v40VAE-inpainting", torch_dtype=torch.float32)
...
def test_StableDiffusionFillInpaintPipeline_textEmbedding():
    try:
        ...
        pipe = StableDiffusionFillInpaintPipeline.from_pretrained("Uminosachi/realisticVisionV40_v40VAE-inpainting", torch_dtype=torch.float32)
...
def test_StableDiffusionWebuiInpaintPipeline():
    try:
        ...
        pipe = StableDiffusionWebuiInpaintPipeline.from_pretrained("Uminosachi/realisticVisionV40_v40VAE-inpainting", torch_dtype=torch.float32)
...
def test_StableDiffusionControlNetFillInpaintPipeline():
    try:
        ...
        pipe = StableDiffusionControlNetFillInpaintPipeline.from_pretrained(
            "whooray/realistic-vision-1.3-inpainting", controlnet=controlnet, torch_dtype=torch.float32
        )
